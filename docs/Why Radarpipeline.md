...
**Ready to get started?** Check out our [Installation Guide](https://github.com/RADAR-base/radarpipeline/wiki/Installation) and run your first pipeline in minutes!
