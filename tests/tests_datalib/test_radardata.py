...
class TestRadarData(unittest.TestCase):
    ...
    def test_get_data(self):
        self.assertDictEqual(self.radar_data.get_data(), {"test_user_data": self.radar_user_data})
    ...
    def test_get_data_by_user_id(self):
        self.assertEqual(self.radar_data.get_data_by_user_id("test_user_data"), self.radar_user_data)
    ...
    def test_get_combined_data_by_variable(self):
        assert_frame_equal(self.radar_data.get_combined_data_by_variable("test_variable_data"), self.mock_pandas)